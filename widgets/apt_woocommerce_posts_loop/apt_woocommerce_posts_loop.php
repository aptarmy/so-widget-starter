...
/*
Widget Name: APT WooCommerce Posts loop
...
class APT_WooCommerce_Posts_Loop extends APT_Widget_Woocommerce
{
    ...
    function __construct()
    {
        ...
        parent::__construct(
            ...
            'apt_woocommerce_posts_loop',

            // The name of the widget for display purposes.
            __('APT WooCommerce Posts Loop', 'apt_widgets'),

            // The $widget_options array, which is passed through to WP_Widget.
            // It has a couple of extras like the optional help URL, which should link to your sites help or support page.
            array(
                'description' => __('This widget is intended to be overrided', 'apt_widgets'),
    ...
    function get_less_variables($instance)
    {
        ...
        if (isset($instance["background_color"])) {
            $less_vars["background_color"] = $instance["background_color"];
        }
        return $less_vars;
    }
}
// siteorigin_widget_register($desired_widget_id, $path_to_widget, $class_used_to_create_widget)
siteorigin_widget_register('apt_woocommerce_posts_loop', __FILE__, 'APT_WooCommerce_Posts_Loop');

/**
 * Widget Image profile
 */
function apt_so_widget_woocommerce_posts_loop_image_profile($banner_url, $widget_meta)
{
    if ($widget_meta['ID'] == 'apt_woocommerce_posts_loop') {
        $banner_url = theme_dir_url(__FILE__) . 'widget-image-profile.svg';
    }
    return $banner_url;
}
add_filter( 'siteorigin_widgets_widget_banner', 'apt_so_widget_woocommerce_posts_loop_image_profile', 10, 2);
